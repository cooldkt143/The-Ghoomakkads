    ...
    <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-20">
      <div className="text-center mb-0 px-2">
        <img
            ...
            src="\images\logo-ghoomakkads (2).png"
            alt="Logo"
            width="80"
            height="44"
          />
        <h2 className="text-6xl font-bold mb-4">Contact Us</h2>
        <p className="text-2xl font-['Abril_Fatface'] max-w-2xl mx-auto mb-8 text-gray-300">
      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className='text-xl'>4671 Sugar Camp Road,<br />Owatonna, Minnesota, 55060</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className='text-xl'>1800-123-123</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className='text-xl'>theghoomakkads@ghoomakkads.org</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white text-black rounded-lg p-8 shadow-lg">
          ...
          <form className=" text-4xl space-y-6">
            ...
            <button
              type="submit"
              className="text-white px-6 py-2 bg-gray-700 w-full hover:bg-gray-900 hover:w-full hover:text-white transition"
            >
              Send
            </button>
          </form>
