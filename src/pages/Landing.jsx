    ...
    <div className="fixed top-0 left-0 w-full font-[Poppins] text-gray-700 bg-gray-100">
      ...
      >
        <div className="mt-20 max-w-lg text-gray-800">
          ...
          />
          <h1 className="text-3xl lg:text-4xl text-red-500 font-bold mb-4">
            The Ghoomakkads
          </h1>
          <h2 className="text-xl lg:text-2xl text-red-500 mb-4">
          ...
          <button
            onClick={openHome}
            className="px-6 py-2 text-base lg:text-xl bg-red-500 text-white font-semibold hover:bg-red-600 transition rounded"
          >
            Let&apos;s Go!
          </button>
        </div>
