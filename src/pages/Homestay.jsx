...
import bgImg from "../assets/images/tourpagebg.gif";
import tourImg from "../assets/images/strangertourpage.jpg";
...
const Tour = () => {
  ...
  return (
    ...
    >
      ...
      <section id="chat" className="w-[290px] lg:w-full max-w-xl bg-white p-8 mt-24 rounded-xl shadow-lg">
